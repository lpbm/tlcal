...
class Calendar:
    ...
    def load_calendar(self, calendar=liquid.SC2_LABEL, raw_content=""):
        """
    ...
    def load_event_info(self, event_content, calendar=liquid.SC2_LABEL):
        """
        :cal_id: int
        :return:
        """
